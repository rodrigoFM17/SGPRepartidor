...
class RegisterRepository {
    ...
    suspend fun registerClient (registerClientDTO: RegisterClientDTO): Result<APIResponse<Client>> {
        return try {
    ...
    suspend fun registerDelivery (registerDeliveryDTO: RegisterDeliveryDTO): Result<APIResponse<Delivery>> {
        return try {
